...
def test_chunker_preserves_page_numbers():
    pages = [
        PDFPage(page=1, text="This is page one."),
        PDFPage(page=2, text="This is page two."),
    ]
    chunker = TextChunker(chunk_size=100, chunk_overlap=20)
...
def test_chunk_ids_are_global_across_pages():
    pages = [
        PDFPage(page=1, text="First page."),
        PDFPage(page=2, text="Second page."),
        PDFPage(page=3, text="Third page."),
    ]
    chunker = TextChunker()
